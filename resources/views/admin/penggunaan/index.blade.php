...
<head>
    <meta charset="UTF-8">
    <title>Kelola Data Penggunaan</title>
    <style>
        body {
...
<body>
    <h1>Kelola Data Penggunaan</h1>
    <a href="{{ route('admin.dashboard') }}">Kembali ke Dashboard</a>
    <hr>

    <a href="{{ route('admin.penggunaan.create') }}" class="btn btn-add">+ Input Penggunaan Baru</a>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" style="text-align: center;">Belum ada data penggunaan.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
